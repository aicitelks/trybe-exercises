...
//O middleware de admin deve ser executado após o middleware de autenticação. Sendo assim, vamos procurar por req.user para obter o valor da propriedade admin para aquela pessoa. 
